...
extension UIView {
    ...
    public func showMessage(_ message: String) {
        ...
        let size = label.text!.boundingRect(with: CGSize(width: frameW - 60, height: CGFloat(MAXFLOAT)), options: .usesLineFragmentOrigin, attributes: [.font: label.font], context: nil).size
